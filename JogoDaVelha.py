...
co4 = "#00FFFF"   # aqua
co5 = "#FFFF00"   # amarela / yellow
co6 = "#fcc058"  # laranja / orange
co7 = "#FF4500"   # orangeRed
co8 = co4   # + verde
co10 = "#fcfbf7"
co11 = "#7B68EE"  # mediumStateBlue
co12 = "#F0FFF0"  # verde clarinho
co13 = "#FF0000"  # vermelho
fundo = "#363636"  # preta / black
...
# Criando o frame de Titulo


# Dividindo a janela em 2 frames ---------------------------------------

frame_cima = Frame(janela, width=240, height=110, bg=co1, relief="raised")
...
def iniciar_jogo():
    ...
    def vencedor(i):
        ...
        app_vencedor = Label(frame_baixo, text='', width=17, relief='flat',
                             anchor='center', font=('Ivy 13 bold'), bg=fundo, fg=co5)
        app_vencedor.place(x=40, y=235)
        ...
        # Botao jogar
        b_jogar = Button(frame_baixo, command=start, text='Próxima rodada', height=1,  font=(
            'Ivy 10 bold'), overrelief=RIDGE, relief='raised', bg=fundo, fg=co0)
        b_jogar.place(x=70, y=205)
    ...
    def terminar():
        ...
        app_fim = Label(frame_baixo, text='Jogo Acabou!', width=17, relief='flat',
                        anchor='center', font=('Ivy 13 bold'), bg=fundo, fg=co1)
